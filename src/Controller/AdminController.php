...
class AdminController extends Controller
{
    ...
    public
    function accountSettings(Request $request, UserPasswordEncoderInterface $passwordEncoder)
    {
        $entityManager = $this->getDoctrine()->getManager();
    ...
    public
    function deleteCurrentAccount(TokenStorageInterface $tokenStorage)
    {
        $entityManager = $this->getDoctrine()->getManager();
        $user = $entityManager->getRepository(User::class)->find($this->getUser()->getId());
    ...
    public
    function generateCSRFToken($tokenName)
    {
    ...
    public
    function renderCSRFToken($tokenValue)
    {
